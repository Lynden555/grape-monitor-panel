...
///const AGENT_DOWNLOAD_URL = 'https://github.com/Lynden555/grape-monitor-agent/releases/download/v3.3.2/Grape-Monitor-Setup-3.3.2.exe';

const AGENT_DOWNLOAD_URL = 'https://github.com/Lynden555/grapeassist-software/releases/download/v3.1.0/Grape.Monitor.Setup.3.1.0.exe';
////const AGENT_DOWNLOAD_URL = 'https://github.com/Lynden555/grapeassist-software/releases/download/2.9.7/Grape.Monitor.Setup.2.9.7.exe';
