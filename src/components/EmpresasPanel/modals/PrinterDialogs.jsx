...
export const PrinterContextMenu = ({ contextMenu, onClose, onRename, onDelete }) => (
  <Menu
  ...
  >
    <MenuItem
      onClick={() => onRename(contextMenu.printer)}
      sx={{
    ...
    <MenuItem
      onClick={() => onDelete(contextMenu.printer)}
      sx={{
        color: '#ef4444',
        fontSize: '14px',
...
export const RenamePrinterDialog = ({ dialog, setDialog, onConfirm }) => (
  <Dialog
    open={dialog.open}
    onClose={() => setDialog({ open: false, printer: null, newName: '' })}
  ...
  >
    ...
    <DialogActions sx={{ px: 3, pb: 2.5, gap: 1 }}>
      <Button
        onClick={() => setDialog({ open: false, printer: null, newName: '' })}
        sx={cancelBtnSx}
      >
        Cancelar
      </Button>
...
export const DeletePrinterDialog = ({ dialog, setDialog, onConfirm }) => (
  <Dialog
    open={dialog.open}
    onClose={() => setDialog({ open: false, printer: null })}
  ...
  >
    ...
    <DialogActions sx={{ px: 3, pb: 2.5, gap: 1 }}>
      <Button
        onClick={() => setDialog({ open: false, printer: null })}
        sx={cancelBtnSx}
      >
        Cancelar
      </Button>
