...
// Lista completa de países según ISO 3166-1 alpha-2
// Ordenada con LATAM + España arriba para facilitar selección, resto alfabético

export const COUNTRIES = [
  // 🌎 LATAM + España (destacados arriba)
  { code: 'MX', name: 'México' },
  ...
  { code: 'CG', name: 'Congo' },
  { code: 'CD', name: 'Congo (Rep. Democrática)' },
  ...
  { code: 'SZ', name: 'Esuatini (Suazilandia)' },
  ...
  { code: 'GS', name: 'Islas Georgias del Sur' },
